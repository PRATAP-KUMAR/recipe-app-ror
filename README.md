...
- Its a Recipe App. Shows all details about Recipe, Food and its prices.
...
````
git clone https://github.com/PRATAP-KUMAR/recipe-app-ror
cd recipe-app-ror
ls
````
...
- **What is this repo for**
  ...
  - Its part of Microverse Group Project built with Ruby on Rails for a Recipe App
